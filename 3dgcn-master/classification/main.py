...
from model_basecnn import BaseCNN
...
def main():
    ...
    parser.add_argument('-model', default='dgcnn', help='[pointnet/dgcnn/gcn3d/basecnn]')
    ...
    parser.add_argument('-dataset', default='ModelNet40_1024_points', help="Path to modelnet point cloud data")
    # parser.add_argument('-load', default='model_gcn3d.pkl', help='Path to load model')
    # parser.add_argument('-load', default='model_pointnet.pkl', help='Path to load model')
    parser.add_argument('-load', default='model.pkl', help='Path to load model')
    parser.add_argument('-save', default='model.pkl', help='Path to save model')
    parser.add_argument('-record', default='record.log', help='Record file name (e.g. record.log)')
